...
int sys_exofork(void) {
    ...
    memcpy(&(e->env_tf), ((struct Trapframe*)(KSTACKTOP)-1),
...
void sys_set_ret(int ret) {
    curenv->env_ret = ret;
}
//! challenge-shell end

//! challenge-shell start
int sys_env_status(int env_id) {
    struct Env* e;
...
void* syscall_table[MAX_SYSNO] = {
    ...
    //! challenge-shell start
    [SYS_set_ret] = sys_set_ret,
    [SYS_env_status] = sys_env_status,
    //! challenge-shell end
};
